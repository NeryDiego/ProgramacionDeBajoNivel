...
angleX = 0.99*(RotacionX + (gyro_xout/131)*dt) + 0.5*accel_xout_scaled
angleY = 0.99*(RotacionY + (gyro_yout/131)*dt) + 0.5*accel_yout_scaled

print "Filter Rotacion X:", angleX
print "Filter Rotacion Y:", angleY
